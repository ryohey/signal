...
export function useRootView() {
  return {
    ...
    get openMidiCliDialog() {
      return useAtomValue(openMidiCliDialogAtom)
    },
    ...
    setOpenMidiCliDialog: useSetAtom(openMidiCliDialogAtom),
  }
}
...
const openMidiCliDialogAtom = atom<boolean>(false)
